...
const Contact = () => {
  return (
    <div className='mt-16 max-w-[1740px] mx-auto relative'>
        <div className='bg-[#f4edf3] -mt-16 -z-50 h-[30rem] w-full absolute'>
        </div>
        <img className='w-full p-16 z-50' src={Banner} alt="" />
        <div className='bg-white sm:absolute bottom-16 right-16 flex flex-col px-24 pb-12 pt-12 gap-y-4'>
