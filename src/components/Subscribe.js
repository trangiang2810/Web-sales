...
const Subscribe = () => {
  return ( 
    <div className='mt-20 my-36 w-full bg-[#edf2f4] py-24'>
        <div className='flex max-md:flex-col w-full mx-auto px-4 xs:max-w-[540px] sm:max-w-[720px] md:max-w-[960px] lg:max-w-[1200px] xl:max-w-[1400px] xxl:max-w-[1740px]'>
            ...
            <div className='w-1/2 max-md:w-full'>
                <div className='w-full flex'>
                    ...
                    <button className='border-b-2 text-[12px] w-[70px] font-medium border-black '>ĐẶT MUA</button>
                </div>
            </div>
        </div>
    </div>
